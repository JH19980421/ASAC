...
function App() {
  ...
  const handleClickOutside = ({ target }) => {
    if (modal && modalEl.current.contains(target)) {
      setModal(false);
    }
  };
  ...
  return (
    <div>
      {/* {modal === false ? <Modal modalEl={modalEl} setModal={setModal} /> : null} */}

      {modal === true ? <Modal modalEl={modalEl} setModal={setModal} /> : null}
