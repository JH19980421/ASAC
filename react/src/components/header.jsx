...
const expandMenus = require("../../src/datas/expand-menu.json");
const menuDetails = require("../../src/datas/menu-details.json");
...
function Header() {
    ...
    return (
        <HeaderContainer>
            ...
            {showSearchBar ? (
                <SearchBar showSearchBar={setShowSearchBar} />
            ) : null}
            <MenuImage
                    ...
                    <ul>
                        ...
                        {expandMenus.map((menu) => (
                            <li
                                key={menu.id}
                                onMouseOver={() =>
                                    onMouseEnterExpandedMenu(menu.content)
                                }
