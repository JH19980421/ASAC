...
const agreementItems = require("../../datas/agreement-item.json");
...
function LoginModal(props) {
    ...
    return (
        <>
            <div className="hider" ref={hider} onClick={closeModals}></div>
            ...
            <div className="login-modal" ref={loginModal}>
                ...
                <input
                    className={
                        isEmailValid ? "email-input" : "email-input-alert"
                    }
                    type="text"
            ...
            <div className="login-modal-join" ref={joinModal}>
                ...
                <div className="agreement">
                    <input
                        ...
                        checked={
                            checkedItems.length === agreementItems.length
                                ? true
                                : false
                        }
                    />
