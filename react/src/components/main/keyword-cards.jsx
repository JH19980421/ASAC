...
const keywordCard = require("../../datas/keyword-card.json");
        ...
        <div className="keywords__card-detail">
            {keywordCard.map((item, idx) => (
                <div className="keywords__card" key={item.id}>
                    ...
                    <p className="keywords__card--title">
                        {item.title} {item.id}
                    </p>
                    <p className="keywords__card--content">{item.content}</p>
                    <div className="keywords__card--badge">
                        <img src={item.badgeUrl} alt="badge" />
                        <p className="keywords__card--badge-name">
                            {item.badgeName}
                        </p>
                    </div>
                </div>
