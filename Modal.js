...
function Modal(props) {
  ...
  //   if (modal2 && modalEl.current.contains(target)) {
  //     setModal2(false);
  //   }
  // };
  ...
  return (
    <div>
      ...
      {/* {modal2 ? <Modal2 modalEl={modalEl} setModal2={setModal2} /> : null} */}
      <div className="modal" ref={props.modalEl}>
        <div class="modal_wrap">
          <div class="modal_page">
            <div class="modal_box">
              <div class="modal_header">
                <span>
                  <svg viewBox="0 0 343 43" class="css-1tw50lz">
                    <path
