  ...
  return (
    ...
    <div className="modal-window">
        <div className="modal-header">
            ...
            <h1> </h1>
            <button className="close-area"><svg width="24" height="24" viewBox="0 0 24 24" color="#999">
        ...
        <div className="modal-body">
            ...
            <div className="login">
                <div className="login_email">
                    <label for="email" className="email_label">이메일</label>
                    <div className="email_inputobx"><input type="email" placeholder="이메일을 입력해 주세요." id="email" value=""/></div>
                    <div className="email_error">올바른 이메일 형식을 입력해주세요.</div>
                </div>

                <div className="login_panel">
                    <button type="button" className="login_email_button"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                            height="24" viewBox="0 0 24 24">
                            <g fill="none" fill-rule="evenodd" stroke="#FFF" stroke-width="2">
                                <rect width="17.2" height="14" x="3.4" y="5" rx="3"></rect>
                                <path d="M3.2 5.6L12 12l8.8-6.4"></path>
                            </g>
                        </svg>이메일로 계속하기</button>
                    ...
                    <div className="login_panel_socialbox">
                        <ul>
                            <li><a href="/"><img src={require("../../../images/kakao.png")} alt=''/>
                                    <p>kakao</p>
                                </a> </li>
                            <li><a href="/"><img src={require("../../../images/facebook.png")} alt=''/>
                                    <p>facebook</p>
                                </a></li>
                            <li><a href="/"><img src={require("../../../images/google.png")} alt=''/>
                                    <p>google</p>
                                </a></li>
                            <li><a href="/"><img src={require("../../../images/apple.png")} alt=''/>
                                    <p>apple</p>
                                </a></li>
                        </ul>
                ...
                <p className="modal_footer">
                    걱정마세요! 여러분의 지원 활동은 SNS에 노출되지 않습니다.<br/>회원가입 시
                    <a href="https://help.wanted.co.kr/hc/ko/articles/360035484292">개인정보 처리방침</a> 과
        ...
        <div className="modal_input_body">
            ...
            <div className="phone">
                ...
                <div className="certification_number"><input type="text" placeholder="인증번호를 입력해 주세요."
                        id="certification_number" value=""/></div>
            </div>
            <div className="password">
                <h1>비밀번호</h1>
                <div className="inputobx"><input type="text" placeholder="비밀번호를 입력해 주세요." id="password" value=""/>
                </div>
                <h2>영문 대소문자, 숫자, 특수문자를 3가지 이상으로 조합하여 8자 이상 입력해 주세요. <br/></h2>
            </div>
            <div className="password_commit ">
                <h1>비밀번호 확인</h1>
                <div className="inputobx"><input type="text" placeholder="비밀번호를 다시 한번 입력해 주세요." id="password_commit"
                        value=""/>
                </div>
            </div>
            <div className="agreement ">
                <div>
                    <div className="checkbox"><input type="checkbox" name="allAgreement1"/>전체 동의</div>
                </div>
                <hr/>
                <div>
                    <div className="checkbox"><input type="checkbox" name="allAgreement2"/>개인정보 수집 및 이용 동의
                        <a href="https://help.wanted.co.kr/hc/ko/articles/360040127872" rel="noopener noreferrer"
                            target="_blank" className="Agreement_link__qZ81b">자세히</a>
                    </div>
                </div>
                <div>
                    <div className="checkbox"><input type="checkbox" name="allAgreement3"/>이벤트 소식 등 알림 정보 받기
                        <a href="https://help.wanted.co.kr/hc/ko/articles/360040540111" rel="noopener noreferrer"
                            target="_blank" className="Agreement_link__qZ81b">자세히</a>
                    </div>
                </div>
            </div>
