    ...
    return (
        <div id="modal" className="modal-overlay">
            <div className="modal-window">
                ...
                <div className="modal-body" style={visual ? { display: 'none' } : { display: 'block' }}>
                    <div className="title">
                        <h1>
                            직장인을 위한
                            <br />
                    ...
                    <div className="login">
                        <div className="login_email">
                            <label for="email" className="email_label">
                                이메일
                            </label>
                ...
                <div className="modal_input_body" style={visual ? { display: 'block' } : { display: 'none' }}>
                    <div className="email_box">
                        <h1>이메일</h1>
                        <div className="inputobx">
                            <input readonly={true} type="text" placeholder="이메일을 입력해 주세요." />
                        </div>
                    </div>
                    ...
                    <div className="name">
                        <h1>이름</h1>
                        <div className="inputobx">
                            <input type="text" placeholder="이름을 입력해 주세요." id="name" onChange={appChange} />
                        </div>
                    </div>
                    <div className="phone">
                        <h1>휴대폰 번호</h1>
                        <div className="inputobx">
                            <select type="text" id="phone" value="" onchange="chageLangSelect()">
                                ...
                                <option value=" +1"> +1 Canada</option> <option value="+56">+56 Chile</option> <option value="+86">+86 China</option>
                        ...
                        <div className="certification_number">
                            <input type="text" placeholder="인증번호를 입력해 주세요." id="certification_number" onChange={appChange} />
                        </div>
                    </div>
                    <div className="password">
                        <h1>비밀번호</h1>
                        <div className="inputobx">
                            <input type="text" placeholder="비밀번호를 입력해 주세요." id="password" onChange={appChange} />
                        </div>
                        <h2>
                    ...
                    <div className="password_commit ">
                        <h1>비밀번호 확인</h1>
                        <div className="inputobx">
                            <input type="text" placeholder="비밀번호를 다시 한번 입력해 주세요." id="password_commit" onChange={appChange} />
                        </div>
                    </div>
                    <div className="agreement ">
                        <div>
                            <div className="checkbox">
                                <input type="checkbox" name="allAgreement1" value="0" onClick={choiceChange} checked={choice[0]} />
                                전체 동의
                            </div>
                        </div>
                        <hr />
                        <div>
                            <div className="checkbox">
                                <input type="checkbox" name="allAgreement2" value="1" onClick={choiceChange} checked={choice[1]} />
                                개인정보 수집 및 이용 동의
                                <a
                        ...
                        <div>
                            <div className="checkbox">
                                <input type="checkbox" name="allAgreement3" value="2" onClick={choiceChange} checked={choice[2]} />
                                이벤트 소식 등 알림 정보 받기
                                <a
