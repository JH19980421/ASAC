    ...
    <>
      <div class="job_main">
        ...
        <div class="job_detail">
          <div class="job_detail_contents">
            ...
            <div id="paginated_gallery" class="gallery">
              <div class="gallery_scroller">
                <div><img src={require("../../../images/detail1.webp")} alt="" /></div>
                <div><img src={require("../../../images/detail2.webp")} alt="" /></div>
                <div><img src={require("../../../images/detail3.webp")} alt="" /></div>
                <div><img src={require("../../../images/detail4.webp")} alt="" /></div>
                <div><img src={require("../../../images/detail2.webp")} alt="" /></div>
              </div>
            ...
            <div class="job_detail_contents_title">
              ...
              <div class="sub_tag">
                <ul>
                  <li><a href="#">#퇴사율5%이하</a></li>
                  <li><a href="#">#50명이하</a></li>
                  <li><a href="#">#50명이하</a></li>
                  <li><a href="#">#설립3년이하</a></li>
                  <li><a href="#">#연봉상위11~20%</a></li>
              ...
              <div class="job_detail_description">
                <p>
                  ...
                  아웃코드팀은 기존에 코딩지식이 없으면 하기 어려웠던 데이터 작업을 누구나 할 수 있도록 하는 ‘아웃코드’를 통해서 많은 기업을 도와주고 있습니다. <br /><br />아웃코드는
                  데이터베이스부터 SaaS, 구글시트, API까지 어떤 데이터도 심플하게 자동화할 수 있는 새로운 플랫폼입니다. 아웃코드를 사용하면 코딩, 스크립트, 쿼리, 워크플로우없이
                  누구나 스스로 데이터 수집, 가공, 연동까지 자동화할 수 있습니다. <br /><br />최근 베타 런칭 후 아무런 마케팅없이 입소문 만으로 전세계 80개국, 400여개 고객들이
                  사용 중에 있으며, 많은 회사들의 생산성 향상과 어려웠던 문제들을 해결하고 있습니다. <br /><br />설립단계부터 예비/초기창업패키지 최우수, 블루포인트파트너스에서 초기 투자
                  유치와 팁스, 데이터스타즈에 선정되며 점점 성장하고 있습니다 <br /><br />진지하게 고객의 문제를 해결하고 글로벌 플랫폼을 만들고 있는 아웃코드팀에서 전직군-
                  개발/디자인/PM/마케터 포지션에서 멋진 분들을 찾고 있습니다.<br /><br /><br />- Sep, 2020 - 예비창업패키지 선정<br />- May, 2021 - 시드투자 유치
                  (블루포인트파트너스)<br />- May, 2021 - 초기창업패키지 선정<br />- Sep, 2021- TIPS 선정<br />- May 2022 - 글로벌 베타 서비스
                  런칭<br />- May 2022 - DATA-Stars 선정<br />- Aug 2022- 아웃코드 2.0 베타 서비스 오픈
                </p>
                <h5> 주요업무</h5>
                <p>• 아웃코드 플랫폼의 기능들에 대한 요청사항 생성과 지속적인 개선을 주도 <br />• 사용자 요청/피드백부터 개발까지 포괄하는 Request-Delivery Loop
                  관리<br />• 플랫폼 기능별 전체 수명 주기 관리하고 Cross-functional 커뮤니케이션의 허브 역할<br />• 사용자 경험 개선을 리드</p>
                <h5> 자격요건</h5>
                <p>• 데이터베이스, API, 웹애플리케이션 서비스에 대한 기술적인 이해<br />• 최신의 프로젝트 관리 툴, 사용자 분석 툴에 대한 경험<br />• 데이터와 운영 전반 업무의
                  기초적인 이해</p>
                <h5> 혜택 및 복지</h5>
                <p>- 고객 이해와 피드백을 바탕으로 다 함께 고객의 문제를 해결하는데 집중합니다.<br />- 원팀 스피릿으로 모두가 같이 고민하고, 배려하고 솔선수범합니다.<br />- 업무
                  집중도는 높지만, 편안한 매너와 유머를 잃지 않아요<br />- 자율적인 근무 환경이며, 매주 금요일은 재택이에요.<br />- 최신 장비와 맥북은 필수입니다.<br />- 사무실은
                  강남구 역삼로 160, 8층입니다.</p>
                <h5> 기술스택 ・ 툴 </h5>
                <div class="skill">
                  <ul>
              ...
              <hr class="job_divider"/>
                ...
                <div class="job_place">
                  <div><span class="header">마감일</span><span class="body">2022.11.11</span></div>
                  <div><span class="header">근무지역</span><span class="body">서울특별시 강남구 역삼로 160</span></div>
                </div>
                ...
                <div class="job_logo">
                  <a href="#">
                    <div class="left">
                      ...
                      <div><img src="https://static.wanted.co.kr/images/wdes/0_5.bab24796.png" alt='' /></div>
                ...
                <div class="job_warnning">
                  ...
                  <div class="job_warnning_description">
                    ...
                    <h5>본 채용정보는 원티드랩의 동의없이 무단전재, 재배포, 재가공할 수 없으며, 구직활동 이외의 <br />
                      용도로 사용할 수 없습니다.</h5>
          ...
          <div class="job_detail_aside">
            <div class="job_detail_aside_body">
              ...
              <div class="job_detail_aside_apply">
                지원하기
              </div>
        ...
        <div class="company_list">
          ...
          <div class="item"> <img src="https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fcompany%2F21749%2Fymimve1pltmzbgpg__400_400.jpg&w=400&q=75" alt='' /> <div class="detail"> <h1>ML 엔지니어</h1> <h2>올빅뎃</h2> <button>응답률 매우 높음</button> <h3>서울・한국</h3> <p>채용보상금 1,000,000원</p> </div> </div>
          <div class="item"> <img src="https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fcompany%2F23530%2F87vxxhkryzsrpt1x__400_400.jpg&w=400&q=75" alt='' /> <div class="detail"> <h1>ML 엔지니어</h1> <h2>올빅뎃</h2> <button>응답률 매우 높음</button> <h3>서울・한국</h3> <p>채용보상금 1,000,000원</p> </div> </div>
          <div class="item"> <img src="https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fcompany%2F30060%2F2kv1lzaldpg8usv1__400_400.jpg&w=400&q=75" alt='' /> <div class="detail"> <h1>[전문연구요원 가능] 의료영상 분석을 위한 인공지능 연구원</h1> <h2>메디인테크</h2> <button>응답률 매우 높음</button> <h3>서울・한국</h3> <p>채용보상금 1,000,000원</p> </div> </div>
          <div class="item"> <img src="https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fcompany%2F21749%2Fymimve1pltmzbgpg__400_400.jpg&w=400&q=75" alt='' /> <div class="detail"> <h1>ML 엔지니어</h1> <h2>올빅뎃</h2> <button>응답률 매우 높음</button> <h3>서울・한국</h3> <p>채용보상금 1,000,000원</p> </div> </div>
          <div class="item"> <img src="https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fcompany%2F23530%2F87vxxhkryzsrpt1x__400_400.jpg&w=400&q=75" alt='' /> <div class="detail"> <h1>ML 엔지니어</h1> <h2>올빅뎃</h2> <button>응답률 매우 높음</button> <h3>서울・한국</h3> <p>채용보상금 1,000,000원</p> </div> </div>
          <div class="item"> <img src="https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fcompany%2F30060%2F2kv1lzaldpg8usv1__400_400.jpg&w=400&q=75" alt='' /> <div class="detail"> <h1>[전문연구요원 가능] 의료영상 분석을 위한 인공지능 연구원</h1> <h2>메디인테크</h2> <button>응답률 매우 높음</button> <h3>서울・한국</h3> <p>채용보상금 1,000,000원</p> </div> </div>
          <div class="item"> <img src="https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fcompany%2F21749%2Fymimve1pltmzbgpg__400_400.jpg&w=400&q=75" alt='' /> <div class="detail"> <h1>ML 엔지니어</h1> <h2>올빅뎃</h2> <button>응답률 매우 높음</button> <h3>서울・한국</h3> <p>채용보상금 1,000,000원</p> </div> </div>
